...
> AI-powered YouTube video clipper for Codex or Claude Code. Download videos, generate semantic chapters, clip segments, translate subtitles to bilingual format, and burn subtitles into videos.
...
```bash
npx skills add https://github.com/LeoLin990405/youtube-clipper-skill
```

This command will automatically install the skill to `~/.codex/skills/youtube-clipper/`.

### Option 2: Manual Installation

```bash
git clone https://github.com/LeoLin990405/youtube-clipper-skill.git
cd youtube-clipper-skill
bash install_as_skill.sh
```

The install script will:
- Copy files to `~/.codex/skills/youtube-clipper/` by default
...
The skill uses environment variables for customization. Edit `~/.codex/skills/youtube-clipper/.env`:
...
- Report bugs via [GitHub Issues](https://github.com/LeoLin990405/youtube-clipper-skill/issues)
...
- **Codex or Claude Code** - The AI-powered coding agent environment
...
Original project by [op7418](https://github.com/op7418); adapted for Leo's local Codex skill workflow.
