...
##############################################################################
# YouTube Clipper - Codex/Claude Skill 安装脚本
#
# 功能：
# 1. 自动创建 Skill 目录
# 2. 复制所有必要文件
...
# 主函数
main() {
    print_header "YouTube Clipper - Codex/Claude Skill 安装"

    # 1. 确定 Skill 目录
    SKILLS_ROOT="${SKILLS_ROOT:-$HOME/.codex/skills}"
    SKILL_DIR="$SKILLS_ROOT/youtube-clipper"
    ...
    # 复制所有必要文件，包括 .env.example 和 .gitignore 这类点文件。
    ...
    print_success "YouTube Clipper 已成功安装为 Codex/Claude Skill"
    echo ""
    ...
    print_info "使用方法："
    print_info "  在 Codex 或 Claude Code 中输入："
