...
> 适用于 Codex 或 Claude Code 的 AI 智能视频剪辑工具。下载视频、生成语义章节、剪辑片段、翻译双语字幕并烧录字幕到视频。
...
该命令会自动将 skill 安装到 `~/.codex/skills/youtube-clipper/` 目录。
...
安装脚本会：
- 默认复制文件到 `~/.codex/skills/youtube-clipper/`
...
本 skill 使用环境变量进行自定义配置。编辑 `~/.codex/skills/youtube-clipper/.env`：
...
欢迎贡献！请：
- 通过 [GitHub Issues](https://github.com/LeoLin990405/youtube-clipper-skill/issues) 报告 Bug
- 提交功能请求
- 为改进提交 Pull Request
...
- **Codex 或 Claude Code** - AI 驱动的编程代理环境
...
原项目来自 [op7418](https://github.com/op7418)，此版本适配 Leo 的本地 Codex skill 工作流。
